...
const TSC_ESM_PATH = path.resolve(__dirname, '../dist/mysecrets.js');
const TSC_ESM_SOURCEMAP_PATH = path.resolve(__dirname, '../dist/mysecrets.js.map');

describe('tsc bundle result', () => {
  test('should generate mysecrets.js and mysecrets.js.map for ES2015 modules', (done) => {
